...
export function renderPaymentSummary() {
  ...
  const totalCents = totalPriceBeforeTax + taxCents;
  const paymentSummaryHTML = `

  <div class="payment-summary-title">Order Summary</div>

  <div class="payment-summary-row">
    <div class="items-summary">Items: (${cartQuantity})</div>
  ...
  `;
  document.querySelector(".js-items-summary").innerHTML = paymentSummaryHTML;
}
